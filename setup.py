...
plugin_identifier = "real_time_monitoring"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_real_time_monitoring"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Real_time_monitoring"
...
plugin_url = "https://github.com/you/OctoPrint-Real_time_monitoring"
